...
class RaymondMutex:
    ...
    def enter_critical_section(self):
        print(f"El Nodo- robot {self.node_id} ingresando a la seccion critica")
        # Critical section code here
        self.leave_critical_section()

    def leave_critical_section(self):
        print(f"El Nodo-robot {self.node_id} dejando critical section")
...
class GenerationalCollector:
    def __init__(self, size):
        ...
        self.size = size
        self.young_gen = [None] * size  # Espacio para la generación joven
        self.old_gen = [None] * size    # Espacio para la generación vieja
        self.young_ptr = 0  # Puntero para la próxima asignación en la generación joven
        self.old_ptr = 0    # Puntero para la próxima asignación en la generación vieja
    ...
    def collect_old(self):
        ...
        # Elimina los objetos nulos de la generación vieja
