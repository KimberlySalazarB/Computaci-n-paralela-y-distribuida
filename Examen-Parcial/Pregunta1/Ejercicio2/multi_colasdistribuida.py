...
parser.add_option('-p', '--per_cpu_queues', default=True, help='colas de planificación por CPU (no una)', action='store_true', dest='per_cpu_queues')
